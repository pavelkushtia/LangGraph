...
class EmbeddingExamples:
    ...
    def example_3_memory_retrieval(self):
        ...
        similarities = []
        for i, (msg, embedding) in enumerate(zip(conversation_history, history_embeddings)):
...
def main():
    ...
    try:
        ...
        print("   Start with: ssh sanzad@192.168.1.178 'sudo systemctl start embeddings-server'")
        return
